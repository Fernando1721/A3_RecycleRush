...
public class GameOver extends javax.swing.JFrame {
     ...
     */
    public GameOver(String login, int score, int id, String nomeExibi) {
        super("GAME OVER");
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Miranda\\Pictures\\GAMEOVER.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Principal principal = new Principal(login, scoreArmazenado, id, nomeExibi);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameOver(login, scoreArmazenado, id, nomeExibi).setVisible(true);
            }
        });
    }
