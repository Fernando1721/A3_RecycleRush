...
public class ConfiguracoesTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setIcon(new javax.swing.ImageIcon("C:\\Users\\Miranda\\Pictures\\setaVoltar.png")); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(txtSenhaUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 407, Short.MAX_VALUE)
                        .addComponent(txtLoginUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 407, Short.MAX_VALUE)
                        ...
                        .addComponent(txtNomeExibicao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 404, javax.swing.GroupLayout.PREFERRED_SIZE)
     ...
     ConnectionFactory cf = new ConnectionFactory();
      ...
      private void alterarUsuario() {
		if (txtNomeExibicao.getText().isEmpty()) {
			...
			String update = "update tb_usuario set nomeExibicao=?, login=? where id=?";
			try {
				Connection con = cf.conectar();
				PreparedStatement pst = con.prepareStatement(update);
				pst.setString(1, txtNomeExibicao.getText());
				pst.setString(2, txtLoginUsuario.getText());
				pst.setString(3, txtIdUsuario.getText());
				pst.executeUpdate();
    ...
    private void alterarUsuarioadm() {
		if (txtNomeExibicao.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o nome de exibição");
			txtNomeExibicao.requestFocus();
		} else if (txtLoginUsuario.getText().isEmpty()) {
